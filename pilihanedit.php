...
<html>
    ...
    <body>
        ...
        <div class="container-button">
            <li class="liibu">
                <a href="editdataibu.php" class="btn-edit"><img src="../assets/image/fotoibu.png" alt="Edit Icon" class="icon">EDIT DATA IBU</a>
            </li>
            <li class="liibu">
                <a href="editdataayah.php" class="btn-edit"><img src="../assets/image/fotoayah.png" alt="Edit Icon" class="icon">EDIT DATA AYAH</a>
            </li>
        </div>
    </body>
</html>