...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO smpn2jakarta (nisn, nama, mtk, bindo, ipa, nilai) VALUES ('$nisn', '$nama', '$mtk','$bindo','$ipa','$nilai')");
...
<html>
    ...
    <form action="smpn2jakartainputnilai.php" method="post" name="daftar">
