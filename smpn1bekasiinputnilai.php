...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO smpn1bekasi (nisn, nama, mtk, bindo, ipa, nilai) VALUES ('$nisn', '$nama', '$mtk','$bindo','$ipa','$nilai')");
...
<html>
    ...
    <form action="smpn1bekasiinputnilai.php" method="post" name="daftar">
