...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO smpn3depok (nisn, nama, mtk, bindo, ipa, nilai) VALUES ('$nisn', '$nama', '$mtk','$bindo','$ipa','$nilai')");
...
<html>
    ...
    <form action="smpn3depokinputnilai.php" method="post" name="daftar">
