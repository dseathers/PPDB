...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO smpn4depok (nisn, nama, mtk, bindo, ipa, nilai) VALUES ('$nisn', '$nama', '$mtk','$bindo','$ipa','$nilai')");
...
<html>
    ...
    <form action="smpn4depokinputnilai.php" method="post" name="daftar">
